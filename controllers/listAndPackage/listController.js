...
exports.createList=function(req,res){
    ...
    listServices.createUserList(req.user.uuid,req.body.listName,function(createdList){
...
exports.addToList=function(req,res){
    ...
    listServices.addToList(data,function(addedL){
        if(addedL.success==false)
        req.flash('error','error in adding to list')
        else
...
exports.removeFromList=function(req,res){
    listServices.removeFromList(req.user.uuid,req.params.iid,req.params.lid,function(deleted){
...
exports.deleteList=function(req,res){
    listServices.deleteUserList(req.user.uuid,req.params.iid,function(deleted){
        if(deleted.success==false)
        req.flash('error','error in deleting item')
        res.redirect('user/list/names')
    })
...
exports.postUpdateList=function(req,res){
    ...
    console.log(ids);
     ...
     var promiseArr=[]
 ids.forEach(obj => promiseArr.push( listServices.updateList(obj,req.user.uuid,req.params.lid,cart[obj]) ) ) ;
